...
<div class="tw-scope w-full bg-gradient-to-br from-slate-100 to-slate-200 min-h-screen relative overflow-hidden flex flex-col font-sans">

    {* ----- Навигация по вкладкам ----- *}
    <div class="px-5 py-4 border-b border-white/50 bg-white/50 backdrop-blur-md sticky top-0 z-40 shadow-sm">
        ...
        <ul class="flex flex-wrap gap-2 m-0 p-0 list-none rlsv-tabs">
            <li>
                <a href="#" data-rlsv-tab="overview" class="block px-4 py-2 text-sm font-medium rounded-full bg-white/50 backdrop-blur-sm border-white/40 text-slate-600 hover:bg-slate-200 hover:text-slate-900 transition-colors" style="text-decoration: none;">
                    {__("rlsv_autopost.tab_overview")}
                </a>
            </li>
            {foreach from=$rlsv_platforms item="pf"}
                <li>
                    <a href="#" data-rlsv-tab="ch_{$pf|escape}" class="block px-4 py-2 text-sm font-medium rounded-full bg-white/50 backdrop-blur-sm border-white/40 text-slate-600 hover:bg-slate-200 hover:text-slate-900 transition-colors capitalize" style="text-decoration: none;">
            ...
            {/foreach}
            <li>
                <a href="#" data-rlsv-tab="by_product" class="block px-4 py-2 text-sm font-medium rounded-full bg-white/50 backdrop-blur-sm border-white/40 text-slate-600 hover:bg-slate-200 hover:text-slate-900 transition-colors" style="text-decoration: none;">
    ...
    <main class="flex-1 overflow-y-auto no-scrollbar p-5 pb-24">
        ...
        <div data-rlsv-pane="overview">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 mb-6">
                <div class="bento-card col-span-2 lg:col-span-1 bg-white/40 backdrop-blur-md p-4 rounded-3xl border border-brand/20 shadow-sm flex flex-col justify-center relative overflow-hidden">
                ...
                <div class="bento-card bg-white/40 backdrop-blur-md p-4 rounded-3xl border border-white/50 shadow-sm flex flex-col justify-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div class="bento-card bg-white/40 backdrop-blur-md p-5 rounded-3xl border border-white/50 shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div class="bento-card bg-white/40 backdrop-blur-md p-4 rounded-3xl border border-white/50 shadow-sm flex flex-col gap-2">
                    ...
                    <div class="flex flex-wrap items-center gap-2 mt-2">
                        <span class="text-[10px] bg-white/50 backdrop-blur-sm border-white/40 px-2 py-1 rounded text-slate-600">{$row.platform|escape}</span>
                        ...
                        {else}
                            <span class="text-[10px] bg-white/50 backdrop-blur-sm border-white/40 text-slate-600 px-2 py-1 rounded border-white/50">{$row.status|escape}</span>
                        {/if}
                    </div>
                ...
                {foreachelse}
                <div class="bento-card col-span-1 md:col-span-2 bg-white/40 backdrop-blur-md p-6 rounded-3xl border border-white/50 text-center shadow-sm">
        ...
        {foreach from=$rlsv_platforms item="pf"}
            ...
            <div data-rlsv-pane="ch_{$pf|escape}" style="display:none;">
                ...
                <div class="grid grid-cols-1 mb-6">
                    <div class="bento-card bg-white/40 backdrop-blur-md p-5 rounded-3xl border border-white/50 shadow-sm max-w-2xl">
                        <h3 class="text-xs font-bold text-slate-500 uppercase tracking-widest mb-4">{__("rlsv_autopost.chart_status")}</h3>
                        <div class="flex items-center justify-center">
        ...
        <div data-rlsv-pane="by_product" style="display:none;">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="bento-card bg-white/40 backdrop-blur-md p-5 rounded-3xl border border-white/50 shadow-sm flex flex-col justify-between">
                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-2 mb-4 bg-white/50 backdrop-blur-sm p-3 rounded-2xl border border-white/40">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex flex-wrap gap-2">
                                {foreach from=$p.platforms key="pf" item="pp" name="pp"}
                                    <div class="bg-white/50 backdrop-blur-sm border-white/40 px-2 py-1 rounded text-[10px] text-slate-700 flex gap-1">
                    ...
                    <a href="{$p.edit_url}" class="text-center w-full bg-white/50 backdrop-blur-sm border-white/40 hover:bg-slate-200 text-slate-700 text-xs font-medium py-2 rounded-xl transition-colors border-white/50" style="text-decoration: none;">
